...
Use this page as the single entry point for payment-related docs.

## Start Here

- [Payment Confirmation Operational Guide](./changes/003-payment-confirmation-operational-guide.md)
- [Payment Retry Demo Runbook](./changes/004-payment-retry-demo-runbook.md)
