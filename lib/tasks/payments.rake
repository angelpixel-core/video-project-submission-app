...
def deliver_signed_webhook(default_type:)
  webhook_port = ENV.fetch("APP_HOST_PORT", ENV.fetch("APP_PORT", 3000))
  webhook_url = ENV["WEBHOOK_URL"].presence || "http://localhost:#{webhook_port}/payments/webhooks/fake/events"
