...
require Rails.root.join("app/domains/projects/application/commands/create_draft_project")

RSpec.describe Projects::Application::Commands::CreateDraftProject do
