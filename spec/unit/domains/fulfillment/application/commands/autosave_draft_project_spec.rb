...
require Rails.root.join("app/domains/fulfillment/application/commands/autosave_draft_project")

RSpec.describe Fulfillment::Application::Commands::AutosaveDraftProject do
